...
cp -r data /
cp dev_coref.json /coref_files/dev_coref.json
...
CUDA_VISIBLE_DEVICES="-1" python3 /app/seq2seq/eval_run_seq2seq.py /app/configs/eval_t5_3b_5696_sparc.json
