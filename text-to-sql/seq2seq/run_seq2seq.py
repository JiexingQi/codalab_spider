...
from seq2seq.utils.lgerels2t5rels import main_preprocessing_process

from model.model_utils import get_relation_t5_model, get_original_t5_model, get_relation_debug_t5_model
...
def main() -> None:
    ...
    #     "dev": eval_dataset
    # }
    # pickle.dump(new_dataset_splits, open("/home/jxqi/text2sql/data/0301_dataset_db_sparc_split.pkl", "wb"))
    # print("save")
    # os._exit()
    ...
    with PicardLauncher() if picard_args.launch_picard and training_args.local_rank <= 0 else nullcontext(None):
        ...
        if data_training_args.lge_relation_path != "":
            ...
            model = get_relation_debug_t5_model(config=config, model_name_or_path=model_args.model_name_or_path)
        else:
